<template>
  <div :style='{"padding":"30px"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="选择考试试卷" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择考试试卷">
          <el-option
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="考试试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
