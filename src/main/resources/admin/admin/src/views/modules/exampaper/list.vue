			...
			<el-form class="center-form-pv" :style='{"padding":"20px 20px 10px","margin":"0 0 20px","borderRadius":"8px","background":"#fff"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考试试卷名称</label>
						<el-input v-model="searchForm.name" placeholder="考试试卷名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
