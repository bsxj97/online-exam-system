  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="密保问题" prop="pquestion">
          <el-input v-model="ruleForm.pquestion"               placeholder="密保问题" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="密保答案" prop="panswer">
          <el-input v-model="ruleForm.panswer"               placeholder="密保答案" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="教师工号" prop="jiaoshigonghao">
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="职称" prop="zhicheng">
          <el-input v-model="ruleForm.zhicheng"               placeholder="职称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="电话" prop="dianhua">
